...
/** 
 * General purpose HttpServletRequest implementation 
 */
  ...
  implements HttpServletRequest
{
  ...
  protected static final VariableMap NULL_FORM=new VariableMap();
  ...
  protected VariableMap _query;
  protected VariableMap _post;
  ...
  public String[] getParameterValues(String name)
	{
    ensureParameters();
    String[] queryRet=_query.getValues(name);
    String[] postRet=_post.getValues(name);
...
//    }
  ...
  public StringBuffer getRequestURL()
  {
	...
	{ 
	  ...
	  _pathInfo=requestURI.substring
  ...
  {
    if (_query==null)
    { _query=VariableMap.fromUrlEncodedString(getQueryString());
    }
  }
    ...
    if (_post==null)
    {
      ...
      { 
        try
        {
          ...
          _post=VariableMap.fromUrlEncodedString(postString);
        }
        catch (IOException x)
        { 
          _log.log
